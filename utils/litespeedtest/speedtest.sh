...
chmod +x ./lite
sudo nohup proxychains ./lite --config ./utils/litespeedtest/lite_config.json --test https://raw.githubusercontent.com/rxsweet/fetchProxy/main/sub/nocheckClash.yml >speedtest.log 2>&1 &
