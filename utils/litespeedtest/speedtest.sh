...
chmod +x ./lite
sudo nohup proxychains ./lite --config ./utils/litespeedtest/lite_config.json --test https://raw.githubusercontent.com/rxsweet/getAirport/main/sub/check/rx >speedtest.log 2>&1 &
